    <div class="login-area" style="background: var(--main-gradient)">
    <div class="container">
            ...
            <div class="col-lg-8">
                <form class="login-form default-form-wrap" name="autentificacion_frm" action="admin/validar.php" method="post" enctype="application/x-www-form-urlencoded">
                    ...
                    <div class="single-input-wrap mb-4">
                        ...
                        <input type="password" placeholder="Ingresa clave" name="contrasena">
                    </div>
                    <button type="submit" class="btn btn-base w-100" value="Ingresar">Entrar</button>   
                </form>
            </div>
        </div>
    </div>
